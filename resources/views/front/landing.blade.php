...
@section('content')
  <!-- Masthead-->
  <header class="masthead bg-info text-center text-white">
    <div class="d-flex align-items-center flex-column container">
      <!-- Masthead Avatar Image-->
      <img class="masthead-avatar mb-5" src="{{ asset('front/img/avataaars.svg') }}" alt="img-hero" />
      <!-- Masthead Heading-->
      <h1 class="masthead-heading text-uppercase mb-0">Siaga Banjir</h1>
      <!-- Icon Divider-->
